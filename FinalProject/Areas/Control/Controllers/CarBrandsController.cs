...
namespace FinalProject.Areas.Control.Controllers
{
    ...
    public class CarBrandsController : Controller
    {
        ...
        public CarBrandsController(RentNowContext context)
        {
            _context = context;
        }

        // GET: Control/CarBrands
        public async Task<IActionResult> Index()
        {
            return View(await _context.CarBrands.ToListAsync());
        }

        // GET: Control/CarBrands/Details/5
        ...
        // GET: Control/CarBrands/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Control/CarBrands/Create
        ...
        // GET: Control/CarBrands/Delete/5
        ...
        // POST: Control/CarBrands/Delete/5
